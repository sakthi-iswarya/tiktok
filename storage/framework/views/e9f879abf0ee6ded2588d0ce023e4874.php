...
<html lang="en">
  <head>
    ...
    <!-- Identity -->
    <title>TikRoyal</title>
    <meta name="description" content="">
    <meta name="author" content="Codings">
    <link rel="shortcut icon" href="assets/img/apple-icon-180.png" type="image/x-icon" />
...
<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/owl-carousel/1.3.3/owl.transitions.css">
  ...
  <body class="shock-body">
    ...
    <script src="ssets/js/vendor/cursor-effect.min.js"></script>
...
<script>
  ...
  </html><?php /**PATH C:\xampp\htdocs\tiktok\resources\views/web/layout/web.blade.php ENDPATH**/ ?>